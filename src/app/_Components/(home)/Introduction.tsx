...
const Introduction = () => {
  return (
    <div className="max-w-sm ml-4 tablet:mx-auto tablet:flex tablet:flex-col tablet:items-center tablet:justify-center tablet:mb-20">
      {/* Teks Utama */}
      <h1 className="text-8xl font-bold leading-tight text-black tablet:text-center">
